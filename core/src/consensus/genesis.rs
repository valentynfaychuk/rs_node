...
const POP: [u8; 96] = [
    ...
    245, 51, 47, 218, 15, 207, 190, 73, 40, 128, 108, 147, 250, 88, 241, 61, 129, 47, 189, 173, 118, 76,
];
...
const GENESIS_HEADER_BIN: &[u8] = &[
    ...
    27, 75, 245, 48, 112, 140, 244, 78, 114, 11, 45, 8, 201, 199, 184, 71, 69, 96, 112, 52, 204, 31, 56, 143, 115, 222,
    87, 7, 185, 3, 168, 252, 90, 91, 114, 16, 244, 47, 228, 198, 82, 12, 130, 10, 126, 118, 193, 119, 4, 115, 108, 111,
    116, 97, 0, 119, 8, 116, 120, 115, 95, 104, 97, 115, 104, 109, 0, 0, 0, 32, 175, 19, 73, 185, 245, 249, 161, 166,
    160, 64, 77, 234, 54, 220, 201, 73, 155, 203, 37, 201, 173, 193, 18, 183, 204, 154, 147, 202, 228, 31, 50, 98, 119,
    2, 118, 114, 109, 0, 0, 0, 96, 181, 221, 57, 62, 159, 101, 228, 75, 242, 59, 58, 92, 179, 234, 71, 120, 2, 232,
    181, 156, 102, 142, 148, 152, 180, 116, 198, 158, 94, 152, 24, 27, 115, 224, 103, 169, 12, 237, 98, 44, 113, 237,
    198, 210, 218, 83, 162, 181, 5, 65, 253, 232, 57, 140, 196, 121, 187, 108, 46, 68, 159, 45, 220, 62, 254, 201, 44,
    135, 201, 126, 206, 74, 140, 239, 177, 95, 169, 40, 181, 104, 167, 84, 50, 207, 85, 35, 42, 10, 36, 196, 9, 13,
    156, 79, 186, 117,
];
const GENESIS_SIGNATURE: [u8; 96] = [
    ...
    116, 236, 25, 140, 129, 215, 83, 78, 184, 11, 9, 108, 22, 132, 47, 26, 250, 246, 119, 252, 81, 91,
];
...
const GENESIS_HEADER_UNPACKED_VR: [u8; 96] = [
